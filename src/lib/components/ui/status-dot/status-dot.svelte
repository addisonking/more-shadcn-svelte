<!-- $lib/components/ui/status-dot/status-dot.svelte -->
<script lang="ts">
...
>
	{#if pulse}
		<span
				...
				dotVariants({ variant, size: undefined }) // Only apply color class, size comes from parent
			)}
        ></span>
	{/if}
    <span
            ...
            // Re-apply size here to ensure the inner dot fills the container
