...
<DocPage.Root>
    ...
    <DocPage.Content>
        ...
        <DocPage.Text>
            You can customize both the module color and the background color.
        </DocPage.Text>
        <DocPage.Example>
            <DocPage.Preview>
...
/>`}
        ...
        <DocPage.Text>
            ...
            <strong>Note:</strong> Set <code>errorCorrection="H"</code> (High) when using logos to ensure the code remains scannable.
        </DocPage.Text>
        <DocPage.Example>
...
/>`}
        ...
        <DocPage.Example>
            ...
            <DocPage.Code code={`<QRCode.Root value="...">
  {#snippet logo()}
     <Avatar>...</Avatar>
  {/snippet}
</QRCode.Root>`} />
